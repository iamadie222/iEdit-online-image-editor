...
$total_items=sql_query("select count(id) as total from assets where type='frame'")[0]['total'];
?>
    	...
    	?>
          ...
          <h2>Frames
			<a class="btn btn-sm btn-primary float-right " href="frame_add.php" >Add Frame</a>
          </h2>
          ...
          <div class="table table-responsive">
            <table class="table table-striped table-sm">
              ...
              <tbody>
              	<?php 
              	$allCliparts=sql_query("select * from assets where type='frame'");
              	foreach ($allCliparts as $key => $value) {
              		echo "<tr>
		                  ...
		                  <td>";
		                  ?>
		                  <a class="btn-sm btn-primary" href="frame_update.php?id=<?php echo $value['id']; ?>&name=<?php echo $value['name']; ?>">Update</a>
